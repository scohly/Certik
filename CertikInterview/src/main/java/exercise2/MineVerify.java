...
public class MineVerify {
     ...
     */
    public  void verifyChain(List<Block> blockChain) throws UnsupportedEncodingException, NoSuchAlgorithmException {
     ...
     */
    public  Block mineTheNextBlock() throws UnsupportedEncodingException, NoSuchAlgorithmException {
...
//        verifyChain(blockList);
        ...
        blockNew.verifyChain(blocksToMine);
