...
//
//    public FindingTheNonce() throws NoSuchAlgorithmException{
//        this.messageDigest = MessageDigest.getInstance("SHA-256");
//    }
//
//    public String solveHash(String inputText, int leadingZeros) throws UnsupportedEncodingException{
...
//
//
//        FindingTheNonce nonce = null;
//        try{
//            nonce = new FindingTheNonce();
...
//        System.out.println("Random alphanumeric padded string: "+randomStr +" length : "+randomStr.length());
